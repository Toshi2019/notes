...
\section*{単語帳}
近年の院試で出てきた単語をまとめる．
これらの単語の意味がわかることを第一目標とする．
\subsection{京大}
\begin{itemize}
    \item 最小分解体 (2021, 2)
    \item 拡大次数
    \item ガロア群
    \item Garois拡大体 (2019, 2)
    \item 代数拡大体
    \item 部分体
    \item 最小分解体 (2017, 3)
    \item 拡大次数
...
\clearpage
\section{ゼミ用ノート--- 第1章 体の理論}

\subsection{拡大体}

\begin{Definition}[可換環]
    空でない集合$R$が可換環とは$\ldots$
    \begin{itemize}
        \item[(R1)]
        \item[(R2)]
        \item[(R3)]  
...
\begin{Remark*}
    $\{0\}$も体になりうるが，
    本書では体として$\{0\}$でないもののみ考える．    
\end{Remark*}

\begin{Definition}[部分体，拡大体]
\end{Definition}

$\bullet$中間体

$\bullet$ $J_{\alpha}=\{f(X)\in F[X]\mid f(\alpha)=0\}$

\begin{Definition}[(元が) 超越的，代数的]
\end{Definition}

\begin{Example}
    $\cc/\qq$の拡大．

    $i=\sqrt{-1}$, $\sqrt{2}$, $\pi$, $e$
\end{Example}
...
\begin{thebibliography}{15}
    ...
    \bibitem[Ka1]{Ka1} 桂利行, 代数学III 体とガロア理論, 東京大学出版会, 2005.
